...
# Add the parent directory to the path so we can import qytum
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

from qytum.interpreter import QyTumInterpreter
from qytum.lexer import QyTumLexer, TokenType
from qytum.parser import QyTumParser

class TestAdvancedFeatures:
    def setup_method(self):
        self.interpreter = QyTumInterpreter()
